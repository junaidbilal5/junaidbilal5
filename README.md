...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 20px; background-color: #f9f9f9;">
    ...
    <p>
      <!--  <a href="https://twitter.com/junaid_bilal005" target="_blank"> -->
        ...
        <a href="https://www.youtube.com/c/birdeyeviewwithbilal" target="_blank">
    ...
    <div style="max-width: 800px; margin: auto; background: #fff; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        ...
        <ul>
            <li><strong>Programming:</strong> Python, PySpark, SQL, Pandas, NumPy, Seaborn</li>
            <li><strong>Tools:</strong> Azure DataBricks, Power BI, Tabular Editor</li>
            <li><strong>Cloud:</strong> Azure Synapse Analytics, Azure Data Factory</li>
            <li><strong>Visualization:</strong> Power BI, Data Storytelling</li>
        </ul>
        <h2 style="font-size: 20px; color: #333;">Projects</h2>
        <p><strong>Algo – Walmart-USA Project (Azure Data Engineer)</strong><br>
            Developed a data processing solution using Azure Synapse Analytics, Python, PySpark, and Power BI.</p>
        <p><strong>KavTech – YLOPO Real Estate Project (Data Engineer)</strong><br>
            ETL pipeline development and data integration using Pentaho, PostgreSQL, and RETS Connector.</p>
